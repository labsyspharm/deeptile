...
class tile_loader(object):
    def __init__(
        ...
        self.image_identifier = os.path.basename(image_filepath).rstrip('.tif').rstrip('.ome')
        if warm_start:
            # load channel
            ...
            # load image
            image_filepath = os.path.join(self.workspace_folderpath, self.image_identifier+'.hdf5')
    ...
    def __parse_image(self, path: str) -> None:
        ...
        with tifffile.TiffFile(path) as tif:
            ...
            hdf5_path = os.path.join(self.workspace_folderpath, self.image_identifier+'.hdf5')
